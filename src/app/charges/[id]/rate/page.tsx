...
export default async function RatePage({
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      <TopHeader title="Evaluation" backHref="/dashboard" />
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 max-w-md mx-auto w-full">
        <div className="text-center space-y-3 mb-8">
          ...
          <h2 className="text-xl font-bold text-nardo">Evaluez {nom ? decodeURIComponent(nom) : 'le transporteur'}</h2>
          <p className="text-muted text-sm">Votre avis aide la communaute Dottruck</p>
        </div>
        ...
        <form action={submitRating} className="w-full space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-sm font-medium text-muted text-center">Votre note</p>
          ...
          <div className="space-y-1.5">
            <label className="block text-sm font-medium text-muted">
              Commentaire <span className="text-muted/60">— optionnel</span>
            </label>
