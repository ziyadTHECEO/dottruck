    ...
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-4" dir="rtl">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-nardo">كلمة سر جديدة</h1>
          <p className="text-sm text-muted mt-2">دخل كلمة السر الجديدة ديالك</p>
        </div>
        ...
        <form action={updatePassword} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-nardo mb-1.5">كلمة السر الجديدة</label>
            <input
              type="password"
              name="password"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-nardo mb-1.5">أكد كلمة السر</label>
            <input
              type="password"
